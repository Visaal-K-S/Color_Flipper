Hi guys this is my first project using HTML, CSS and JavaScript. This project is picking a colour randomly using an algorithm written in JavaScript and making it as main page background colour.
