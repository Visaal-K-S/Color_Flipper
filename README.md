Hi guys this is my first project using HTML, CSS and Javascript. This project is picking a color roandomly from written algorithm and making it as main page background color.
